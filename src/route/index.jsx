...
import CreateCompany from "../components/application/create-company"
...
export const routes = [
        ...
        { path:"/dashboard/ecommerce/", Component:Ecommerce,userRole:["companyadmin"]},
        ...
        {path:"/app/project/detail/:projectid/", Component:ProjectDetail,userRole:["companyadmin","user"]},
        ...
        {path:"/app/issue/issue/:issueid/", Component:Issue,userRole:["companyadmin","user"]},
